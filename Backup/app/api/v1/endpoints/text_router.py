...
from app.schemas.request.text import TextProcessRequest, TextCompareRequest
from app.schemas.response.text import TextProcessResponse, TextCompareResponse
from app.services.Tools.text_service import TextService
